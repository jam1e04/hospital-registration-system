  ...
  <el-card class="box-card">
      ...
      <el-form :inline="true">
          ...
          <el-form-item label="订单状态">
              <el-select placeholder="选择所有订单状态" v-model="orderStatus" @change="changeOrderState">
...
import type { UserOrderInfoResponseData, Records,
            AllUser, AllUserResponseData, 
            AllOrderState, AllOrderStateResponseData
} from '../../../../api/user/type';
